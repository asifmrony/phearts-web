...
export default function research(mats) {
    const { content, featured_image } = mats?.data?.attributes;
        ...
        <main className='page-research'>
            ...
            <div className='pt-14 pb-14 bg-white'>
                <div className={`hero-width w-full mx-auto text-justify ${poppins.variable} font-poppins page-research__body`}>
                    <h2 className='font-heading text-black text-center mb-8 uppercase'>PHeaRTs Mats</h2>
...
export const getStaticProps = async () => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/mats?populate=*`, {
        method: 'GET',
        headers: {
