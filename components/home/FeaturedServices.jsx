  ...
  return (
    <SwiperSlide key={id}>
      <div className="w-full">
        ...
        >
          <h4
            className={`text-lg text-themeblue font-bold ${poppins.variable} font-poppins mt-3`}
          >
            {heading}
          </h4>
        </Link>
    ...
    <div className="bg-white mt-5 pt-20 pb-28">
      <div className="hero-width w-full mx-auto text-center">
        <span className="bg-themeblue text-white p-2 uppercase mb-4 inline-block text-xs">
          Glimpse of what consists of
        </span>
        <h2 className="uppercase text-[32px] font-black leading-tight mb-14 text-black">
          Our Phearts Clinic
        </h2>
        <div>
          <Swiper
