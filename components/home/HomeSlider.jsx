      ...
      {textVisible && (
        <div className="slider-texts hero-width w-full mx-auto flex items-center">
          <div className={`slider-texts__content`}>
            <p
              className={`font-subheading text-white font-medium mb-1 lg:mb-2 tracking-wide ${poppins.variable} font-poppins`}
            >
              {subheading}
            </p>
            <p
              className={`font-heading text-white font-bold mt-1 mb-5 lg:mb-9 shadow-sm tracking-wide`}
            >
              {heading}
            </p>
            {buttonText && (
